"""
dp_egarch_v2.py  --  Adaptive EGARCH v2 (temporal smoothness penalty)
...
def main():
    ...
    merged = merged.dropna(subset=['rv_yz', 'garch_fc_vol', 'egarch_fc_vol', 'sigma_v2_h1'])
    ...
    rows.append(metrics_row('Adaptive v2',       merged['sigma_v2_h1'].values,  rv, e_g))
    ...
    # ── Stability checks ──────────────────────────────────────────────────────
    print("=" * 72)
    print("STABILITY CHECKS -- Adaptive v2")
    print("=" * 72)
    s = merged['sigma_v2_h1'].values
    ...
    # Save output
    merged[['garch_fc_vol', 'egarch_fc_vol', 'sigma_v2_h1', 'sigma_v2_h5', 'sigma_v2_h21', 'rv_target']].to_csv('data/adaptive_v2_forecasts.csv')
    results.to_csv('data/adaptive_v2_results.csv', index=False)
    print("\nSaved: data/adaptive_v2_forecasts.csv")
    print("Saved: data/adaptive_v2_results.csv")
