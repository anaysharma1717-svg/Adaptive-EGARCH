"""
dp_egarch_v3.py  --  Adaptive EGARCH v3 (feature clipping only)
...
def main():
    ...
    # Feature Clipping ONLY: prevent extreme events from saturating the sigmoid and killing gradients
